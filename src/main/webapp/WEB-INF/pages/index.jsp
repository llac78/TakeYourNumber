...
<body class="p-3 mb-2 bg-light text-dark">
	...
	<h1 align="center" style="margimargin-bottom: 50px;" class="display-4">*** TAKE YOUR NUMBER HERE ***</h1>
	
	<s:form action="${pageContext.request.contextPath }/save" method="post" modelAttribute="numbers_form">
		<input type="hidden" id="generationDate" />
		
		<table align="center">
			<tr>
				<td><button type="submit" class="btn btn-success btn-lg btn-block">GENERATE</button></td>
			</tr>
		</table>
	</s:form>
	...
	<div align="center" style="margin: 40px;">
		<table>
			<tr>
				<td  align="center">
					<c:if test="${lastNumber != null}">
						<h4>Last number</h4>
						<h1 class="text-danger"><c:out value="${lastNumber}" /></h1>
					</c:if>
				</td>
			</tr>
